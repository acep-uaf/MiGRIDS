...
projectSetDir = 'C:\\Users\\jbvandermeer\Documents\ACEP\GBS\GBSTools_0\GBSProjects\StMary\OutputData\Set16c'
runs = range(3)
legTxt = ['500 kW/5 min GBS','750 kW/5 min GBS', '1000 kW/5 min GBS']
timeStep = 1 # seconds
